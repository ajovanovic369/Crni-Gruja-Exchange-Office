...
public class GBPDIN extends ValutaDevize implements Transakcija {

    public GBPDIN() {
    }

    public GBPDIN(String ulaz, double izlaz, double vrednostValute) throws PogresanUnos {
    ...
    public double izvrsenjeTransakcije() {
        ...
        while (true) {
            try {
                setVrednostValute(KursnaListaVrednost.vrednostValute(4, 1));
                setUlaz(sk.nextLine());
    ...
    public String prikazIzvrseneTransakcije() {
        return (Repozitorijum.TRANSAKCIJE_TEKST02 + getIzlaz() + " " + Valute.DIN + " " + Repozitorijum.TRANSAKCIJE_TEKST03 + getUlaz() + " " + Valute.GBP);
    }
