...
public class DINUSD extends ValutaDinari implements Transakcija {

    public DINUSD() {
    }

    public DINUSD(String ulaz, double izlaz, double vrednostValute) throws PogresanUnos {
    ...
    public double izvrsenjeTransakcije() {
        ...
        while (true) {
            try {
                setVrednostValute(KursnaListaVrednost.vrednostValute(2, 3));
                setUlaz(sk.nextLine());
    ...
    public String prikazIzvrseneTransakcije() {
        return (Repozitorijum.TRANSAKCIJE_TEKST02 + getIzlaz() + " " + Valute.USD + " " + Repozitorijum.TRANSAKCIJE_TEKST03 + getUlaz() + " " + Valute.DIN);
    }
