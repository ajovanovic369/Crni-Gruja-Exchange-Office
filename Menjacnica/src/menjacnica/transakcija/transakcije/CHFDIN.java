...
public class CHFDIN extends ValutaDevize implements Transakcija {

    public CHFDIN() {
    }

    public CHFDIN(String ulaz, double izlaz, double vrednostValute) throws PogresanUnos {
    ...
    public double izvrsenjeTransakcije() {
        ...
        while (true) {
            try {
                setVrednostValute(KursnaListaVrednost.vrednostValute(3, 1));
                setUlaz(sk.nextLine());
    ...
    public String prikazIzvrseneTransakcije() {
        return (Repozitorijum.TRANSAKCIJE_TEKST02 + getIzlaz() + " " + Valute.DIN + " " + Repozitorijum.TRANSAKCIJE_TEKST03 + getUlaz() + " " + Valute.CHF);
    }
