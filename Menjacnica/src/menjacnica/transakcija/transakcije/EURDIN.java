...
public class EURDIN extends ValutaDevize implements Transakcija {

    public EURDIN() {
    }

    public EURDIN(String ulaz, double izlaz, double vrednostValute) throws PogresanUnos {
    ...
    public double izvrsenjeTransakcije() {
        ...
        while (true) {
            try {
                setVrednostValute(KursnaListaVrednost.vrednostValute(1, 1));
                setUlaz(sk.nextLine());
    ...
    public String prikazIzvrseneTransakcije() {
        return (Repozitorijum.TRANSAKCIJE_TEKST02 + getIzlaz() + " " + Valute.DIN + " " + Repozitorijum.TRANSAKCIJE_TEKST03 + getUlaz() + " " + Valute.EUR);
    }
